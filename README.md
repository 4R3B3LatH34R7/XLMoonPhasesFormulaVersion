...
###### 34.F_nm
<code>
=(((160.7108+(390.67050274*((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpnm*0.25)))-(0.0016341*POWER((((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpnm*0.25))/1236.85),2))-(0.00000227*POWER((((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpnm*0.25))/1236.85),3))+(0.000000011*POWER((((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpnm*0.25))/1236.85),4)))-(INT((160.7108+(390.67050274*((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpnm*0.25)))-(0.0016341*POWER((((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpnm*0.25))/1236.85),2))-(0.00000227*POWER((((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpnm*0.25))/1236.85),3))+(0.000000011*POWER((((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpnm*0.25))/1236.85),4)))/360)*360))*ATAN(1)*4/180)
  </code>
