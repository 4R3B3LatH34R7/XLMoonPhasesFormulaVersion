...
theDate can be any date that the user required, on which the moonphases calculations will be based on.
TimeZone for Myanmar can be 7.5 as Myanmar is +7hours and 30mins behind Greenwich(UTC time)=0.
...
A01_fm
=(((299.77+(0.107408*((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpfm*0.25)))-(0.009173*POWER((((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpfm*0.25))/1236.85),2)))-(INT((299.77+(0.107408*((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpfm*0.25)))-(0.009173*POWER((((INT(((YEAR(theDate)+(theDate-DATE(YEAR(theDate),1,1))/365.25)-2000)*12.3685))+(mp_mpfm*0.25))/1236.85),2)))/360)*360))*ATAN(1)*4/180)
